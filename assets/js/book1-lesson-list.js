...
(function () {
  ...
  const BOOK1_LESSONS = [
    ...
    { lessonNum: 12, section: 'section-3', slug: 'b1-lesson12', ar: 'الَّذِي — الَّتِي', title: 'Relative Pronouns (Who / Which)', desc: '"The man who…", "The book which…". Forming relative clauses in Arabic.' },
    { lessonNum: 13, section: 'section-3', slug: 'b1-lesson13', ar: 'ذَهَبَ — ذَهَبَتْ', title: 'Past Tense Verbs (He / She)', desc: 'The past tense for third person — "he went", "she went". Expanding verb conjugation.' },
    { lessonNum: 14, section: 'section-3', slug: 'b1-lesson14', ar: 'النَّعْتُ السَّبَبِيّ', title: 'The Causal Adjective', desc: 'A special adjective form that agrees with a word other than the noun it describes — a uniquely Arabic construction.' },
