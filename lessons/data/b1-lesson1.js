...
const LESSON_DATA = {
  ...
  guidedPages: [
    ...
    },
    {
      ...
      pattern: 'مَا هٰذَا؟',
      intro: 'Now use the same words to ask and answer. Each group belongs to one thing.',
      groups: [
        {
          icon: '🏠',
          lines: [
    ...
    },
    {
      ...
      exercise: [
        {
          icon: '🔑',
          ideal: 'هٰذَا مِفْتَاحٌ.',
          accepts: ['هذا مفتاح', 'هذا مفتاح.', 'هٰذَا مِفْتَاحٌ', 'هٰذَا مِفْتَاحٌ.', 'هَذَا مفتاح']
        },
        {
          icon: '📘',
          ideal: 'هٰذَا كِتَابٌ.',
          accepts: ['هذا كتاب', 'هذا كتاب.', 'هٰذَا كِتَابٌ', 'هٰذَا كِتَابٌ.', 'هَذَا كتاب']
        },
        {
          icon: '✏️',
          ideal: 'هٰذَا قَلَمٌ.',
          accepts: ['هذا قلم', 'هذا قلم.', 'هٰذَا قَلَمٌ', 'هٰذَا قَلَمٌ.', 'هَذَا قلم']
        },
        {
          icon: '🚪',
          ideal: 'هٰذَا بَابٌ.',
          accepts: ['هذا باب', 'هذا باب.', 'هٰذَا بَابٌ', 'هٰذَا بَابٌ.', 'هَذَا باب']
        },
        {
          icon: '🏠',
          ideal: 'هٰذَا بَيْتٌ.',
          accepts: ['هذا بيت', 'هذا بيت.', 'هٰذَا بَيْتٌ', 'هٰذَا بَيْتٌ.', 'هَذَا بيت']
        },
        {
          icon: '🪑',
          ideal: 'هٰذَا كُرْسِيٌّ.',
          accepts: ['هذا كرسي', 'هذا كرسي.', 'هذا كرسيّ', 'هٰذَا كُرْسِيٌّ', 'هٰذَا كُرْسِيٌّ.', 'هَذَا كرسي']
        }
      ]
    },
    {
      ...
      exercise: [
        {
          icon: '🕌',
          prompt: 'أَهٰذَا مَسْجِدٌ؟',
          ideal: 'نَعَمْ، هٰذَا مَسْجِدٌ.',
          accepts: ['نعم هذا مسجد', 'نعم هذا مسجد.', 'نَعَمْ، هٰذَا مَسْجِدٌ', 'نَعَمْ، هٰذَا مَسْجِدٌ.', 'نعم، هذا مسجد', 'نعم، هذا مسجد.']
        },
        {
          icon: '🔑',
          prompt: 'أَهٰذَا مِفْتَاحٌ؟',
          ideal: 'نَعَمْ، هٰذَا مِفْتَاحٌ.',
          accepts: ['نعم هذا مفتاح', 'نعم هذا مفتاح.', 'نَعَمْ، هٰذَا مِفْتَاحٌ', 'نَعَمْ، هٰذَا مِفْتَاحٌ.', 'نعم، هذا مفتاح', 'نعم، هذا مفتاح.']
        },
        {
          icon: '👕',
          prompt: 'أَهٰذَا قَمِيصٌ؟',
          ideal: 'نَعَمْ، هٰذَا قَمِيصٌ.',
          accepts: ['نعم هذا قميص', 'نعم هذا قميص.', 'نَعَمْ، هٰذَا قَمِيصٌ', 'نَعَمْ، هٰذَا قَمِيصٌ.', 'نعم، هذا قميص', 'نعم، هذا قميص.']
        },
        {
          icon: '⭐',
          prompt: 'أَهٰذَا نَجْمٌ؟',
          ideal: 'نَعَمْ، هٰذَا نَجْمٌ.',
          accepts: ['نعم هذا نجم', 'نعم هذا نجم.', 'نَعَمْ، هٰذَا نَجْمٌ', 'نَعَمْ، هٰذَا نَجْمٌ.', 'نعم، هذا نجم', 'نعم، هذا نجم.']
        }
      ]
    },
    {
