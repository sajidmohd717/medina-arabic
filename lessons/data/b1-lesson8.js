...
const LESSON_DATA = {
  ...
  vocab: [
    // Sun Letter Examples
    { ar: 'Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³Ù', trans: 'ash-shamsu', meaning: 'The sun', type: 'Noun' },
    { ar: 'Ø§Ù„Ø±ÙŽÙ‘Ø¬ÙÙ„Ù', trans: 'ar-rajulu', meaning: 'The man', type: 'Noun' },
    { ar: 'Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù', trans: 'ad-dÄru', meaning: 'The house / abode', type: 'Noun' },
    { ar: 'Ø§Ù„Ø«ÙŽÙ‘ÙˆÙ’Ø¨Ù', trans: 'ath-thawbu', meaning: 'The garment', type: 'Noun' },
    { ar: 'Ø§Ù„Ø²ÙŽÙ‘Ù‡Ù’Ø±ÙŽØ©Ù', trans: 'az-zahratu', meaning: 'The flower', type: 'Noun' },
    { ar: 'Ø§Ù„Ø³ÙŽÙ‘Ù…ÙŽÙƒÙ', trans: 'as-samaku', meaning: 'The fish', type: 'Noun' },
    { ar: 'Ø§Ù„Ø¸ÙÙ‘Ù‡Ù’Ø±Ù', trans: 'aáº“-áº“uhru', meaning: 'Noon / Midday', type: 'Noun' },
    { ar: 'Ø§Ù„Ù„ÙŽÙ‘Ø­Ù’Ù…Ù', trans: 'al-laá¸¥mu', meaning: 'The meat', type: 'Noun' },
    
    // Moon Letter Examples
    { ar: 'Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±Ù', trans: 'al-qamaru', meaning: 'The moon', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’Ù‡ÙŽÙˆÙŽØ§Ø¡Ù', trans: 'al-hawÄ\'u', meaning: 'The air', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’ÙŠÙŽØ¯Ù', trans: 'al-yadu', meaning: 'The hand', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’ØºÙŽØ¯ÙŽØ§Ø¡Ù', trans: 'al-ghadÄ\'u', meaning: 'The lunch', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’ÙÙŽÙ…Ù', trans: 'al-famu', meaning: 'The mouth', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’Ù…ÙŽØ§Ø¡Ù', trans: 'al-mÄ\'u', meaning: 'The water', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’Ø¹ÙŽÙŠÙ’Ù†Ù', trans: 'al-Ê¿aynu', meaning: 'The eye', type: 'Noun' },
    { ar: 'Ø§Ù„Ù’Ø¬ÙŽÙ†ÙŽÙ‘Ø©Ù', trans: 'al-jannatu', meaning: 'The garden / Paradise', type: 'Noun' }
  ],
  ...
  quizQuestions: {
    multipleChoice: [
      { prompt: 'In the word Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³Ù, is the "L" pronounced?', options: ['Yes', 'No'], correct: 1 },
      { prompt: 'In the word Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±Ù, is the "L" pronounced?', options: ['Yes', 'No'], correct: 0 },
      ...
      { prompt: 'Which of these is a Sun Letter?', options: ['Ø£', 'Ø¨', 'Øª', 'Ø¬'], correct: 2 },
      { prompt: 'Which of these is a Moon Letter?', options: ['Ø¯', 'Ø°', 'Ø±', 'Ù'], correct: 3 },
      { prompt: 'Translate: "The man is in the house."', options: ['Ø§Ù„Ø±ÙŽÙ‘Ø¬ÙÙ„Ù ÙÙÙŠ Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù', 'Ø§Ù„Ø±ÙŽÙ‘Ø¬ÙÙ„Ù Ø¹ÙŽÙ„ÙŽÙ‰ Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù', 'Ø§Ù„Ø±ÙŽÙ‘Ø¬ÙÙ„Ù Ù…ÙÙ†Ù’ Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù', 'Ø§Ù„Ø±ÙŽÙ‘Ø¬ÙÙ„Ù Ø¥ÙÙ„ÙŽÙ‰ Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù'], correct: 0 },
      { prompt: 'How many Sun Letters are there in the Arabic alphabet?', options: ['10', '12', '14', '28'], correct: 2 },
      { prompt: 'Translate: "The air is cold."', options: ['Ø§Ù„Ù’Ù‡ÙŽÙˆÙŽØ§Ø¡Ù Ø­ÙŽØ§Ø±ÙŒÙ‘', 'Ø§Ù„Ù’Ù‡ÙŽÙˆÙŽØ§Ø¡Ù Ø¨ÙŽØ§Ø±ÙØ¯ÙŒ', 'Ø§Ù„Ù’Ù…ÙŽØ§Ø¡Ù Ø¨ÙŽØ§Ø±ÙØ¯ÙŒ', 'Ø§Ù„Ø²ÙŽÙ‘Ù‡Ù’Ø±ÙŽØ©Ù Ø¨ÙŽØ§Ø±ÙØ¯ÙŽØ©ÙŒ'], correct: 1 },
      { prompt: 'Which word uses a Moon Letter?', options: ['Ø§Ù„Ø¯ÙŽÙ‘Ø§Ø±Ù', 'Ø§Ù„Ø«ÙŽÙ‘ÙˆÙ’Ø¨Ù', 'Ø§Ù„Ù’Ø¬ÙŽÙ†ÙŽÙ‘Ø©Ù', 'Ø§Ù„Ø³ÙŽÙ‘Ù…ÙŽÙƒÙ'], correct: 2 },
      { prompt: 'What is the opposite of Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³Ù?', options: ['Ø§Ù„Ù’Ù‡ÙŽÙˆÙŽØ§Ø¡Ù', 'Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±Ù', 'Ø§Ù„Ù’Ù…ÙŽØ§Ø¡Ù', 'Ø§Ù„Ø²ÙŽÙ‘Ù‡Ù’Ø±ÙŽØ©Ù'], correct: 1 }
    ],
    typing: [
      { prompt: 'Type in Arabic: "The sun" (include the shadda)', ideal: 'Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³Ù', accepts: ['Ø§Ù„Ø´Ù…Ø³', 'Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³Ù', 'Ø§Ù„Ø´Ù…Ø³Ù', 'Ø§Ù„Ø´ÙŽÙ‘Ù…Ù’Ø³'] },
      { prompt: 'Type in Arabic: "The moon" (include the sukun)', ideal: 'Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±Ù', accepts: ['Ø§Ù„Ù‚Ù…Ø±', 'Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±Ù', 'Ø§Ù„Ù‚Ù…Ø±Ù', 'Ø§Ù„Ù’Ù‚ÙŽÙ…ÙŽØ±'] }
    ]
  }
};
